...
Shader "Hae_URP_Master"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Mask_Tex_ST;
			float _Blend;
			float _Use_CustomData;
			float _Burn;
			float _Distortion_X_Speed;
			float _Distortion_Y_Speed;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord5 = input.texcoord2;
						 ...
						 ) : SV_Target
			{
				...
				float MainBurn55 = input.ase_texcoord5.x;
				float2 appendResult27 = (float2(_Distortion_X_Speed , _Distortion_Y_Speed));
				float2 uv_Distortion_Tex = input.ase_texcoord6.xy * _Distortion_Tex_ST.xy + _Distortion_Tex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult27 + uv_Distortion_Tex);
				float Distortion57 = input.ase_texcoord5.y;
				...
				float4 tex2DNode21 = tex2D( _Main_Tex, ( ( UnpackNormalScale( tex2D( _Distortion_Tex, panner25 ), 1.0f ) * (( _Use_CustomData )?( Distortion57 ):( _Distortion_Intensity )) ) + float3( panner31 ,  0.0 ) ).xy );
				
				float screenDepth63 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth63 = abs( ( screenDepth63 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( _Depth_Fade ) );
				float2 uv_Mask_Tex = input.ase_texcoord6.xy * _Mask_Tex_ST.xy + _Mask_Tex_ST.zw;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( (( _Use_CustomData )?( MainBurn55 ):( _Burn )) * ( tex2DNode21 * input.ase_color ) ).rgb;
				float Alpha = ( ( ( tex2DNode21.a * input.ase_color.a ) * saturate( distanceDepth63 ) ) * tex2D( _Mask_Tex, uv_Mask_Tex ) ).r;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult27 = (float2(_Distortion_X_Speed , _Distortion_Y_Speed));
				float2 uv_Distortion_Tex = input.ase_texcoord2.xy * _Distortion_Tex_ST.xy + _Distortion_Tex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult27 + uv_Distortion_Tex);
				float Distortion57 = input.ase_texcoord3.y;
				float2 appendResult33 = (float2(_Main_U_Speed , _Main_V_Speed));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 appendResult27 = (float2(_Distortion_X_Speed , _Distortion_Y_Speed));
				float2 uv_Distortion_Tex = input.ase_texcoord.xy * _Distortion_Tex_ST.xy + _Distortion_Tex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult27 + uv_Distortion_Tex);
				float Distortion57 = input.ase_texcoord1.y;
				float2 appendResult33 = (float2(_Main_U_Speed , _Main_V_Speed));
				...
				float screenDepth63 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth63 = abs( ( screenDepth63 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _Depth_Fade ) );
				float2 uv_Mask_Tex = input.ase_texcoord.xy * _Mask_Tex_ST.xy + _Mask_Tex_ST.zw;
				

				surfaceDescription.Alpha = ( ( ( tex2DNode21.a * input.ase_color.a ) * saturate( distanceDepth63 ) ) * tex2D( _Mask_Tex, uv_Mask_Tex ) ).r;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;-591.7467,92.62721;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;60;-39.85538,200.6267;Inherit;True;Property;_Blend;Blend;0;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2;85.19701,1.70394;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Hae_URP_Master;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;False;;10;True;_Blend;0;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;28;Surface;1;638639019483932546;  Blend;0;0;Two Sided;1;638639020170319772;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Forward Only;0;0;Cast Shadows;0;638639020236307650;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;  XR Motion Vectors;0;0;GPU Instancing;1;0;LOD CrossFade;0;638639020227013074;Built-in Fog;0;638639020230561806;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;12;False;True;False;True;False;False;True;True;True;False;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;99;85.19701,101.7039;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;100;85.19701,101.7039;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;XRMotionVectors;0;11;XRMotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;True;1;False;;255;False;;1;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;LightMode=XRMotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;2;3;51;0
ASEEND*/
//CHKSM=805F881495C13D30DEC7F3A84320A64B0647945D